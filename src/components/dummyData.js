export const parksData = {
  ...
  data: [
    ...
    //   ],
      ...
      weatherInfo:
        'Weather in Southwest Texas can change in a matter of minutes. It is best to check the local weather report. Amistad National Recreation Area usually has hot summers and mild winters. For more information, please visit our Current Conditions page at https://www.nps.gov/amis/planyourvisit/conditions.htm.',
      name: 'Amistad',
      designation: 'National Park'
    },
    {
